...
void main() {
  ...
  group('getSupportedLenses() tests', () {
    ...
    test('returns set of supported lenses', () async {
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger.setMockMethodCallHandler(
        ...
        (MethodCall methodCall) async {
          if (methodCall.method == MethodChannelMobileScanner.kGetSupportedLensesMethodName) {
            return [CameraLensType.normal.rawValue, CameraLensType.wide.rawValue, CameraLensType.zoom.rawValue];
          }
          return null;
        },
      );
    ...
    test('maps unknown values to any lens type while keeping valid ones', () async {
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger.setMockMethodCallHandler(
        platform.methodChannel,
        (MethodCall methodCall) async {
          if (methodCall.method == MethodChannelMobileScanner.kGetSupportedLensesMethodName) {
            return [CameraLensType.normal.rawValue, -99, CameraLensType.wide.rawValue];
          }
          return null;
        },
      );
    ...
    test('calls correct method on platform channel', () async {
      ...
      expect(methodCalls.first.method, MethodChannelMobileScanner.kGetSupportedLensesMethodName);
    });
    ...
    test('returns normal and zoom lenses (common dual camera setup)', () async {
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger.setMockMethodCallHandler(
        ...
        (MethodCall methodCall) async {
          if (methodCall.method == MethodChannelMobileScanner.kGetSupportedLensesMethodName) {
            return [CameraLensType.normal.rawValue, CameraLensType.zoom.rawValue];
          }
          return null;
        },
      );
    ...
    test('returns normal, wide, and zoom (common triple camera setup)', () async {
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger.setMockMethodCallHandler(
        platform.methodChannel,
        (MethodCall methodCall) async {
          if (methodCall.method == MethodChannelMobileScanner.kGetSupportedLensesMethodName) {
    ...
    test('deduplicates multiple unknown values to single any lens type', () async {
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger.setMockMethodCallHandler(
        platform.methodChannel,
        (MethodCall methodCall) async {
          if (methodCall.method == MethodChannelMobileScanner.kGetSupportedLensesMethodName) {
            return [CameraLensType.normal.rawValue, -99, CameraLensType.wide.rawValue, -10, 99];
          }
          return null;
        },
      );
